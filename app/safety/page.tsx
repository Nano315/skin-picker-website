...
export const metadata: Metadata = {
  ...
  description:
    "Skin changers that unlock skins you don't own get accounts banned. Skin Picker isn't one: it uses the League Client's own local API to pick among skins you already own. Here's the technical difference, sourced from Riot's own documentation.",
  alternates: {
    canonical: "/safety",
  ...
  openGraph: {
    ...
    description:
      "The technical difference between a skin changer and a client-API tool, sourced from Riot's own documentation.",
    type: "article",
  },
};
...
export default function SafetyPage() {
  ...
  return (
    <ContentPage
      ...
      intro="No — and you shouldn't take that on faith. Skin Picker never touches a game file, never injects code, never reads game memory, and can only ever select cosmetics your account already owns. Below is exactly how it works, what Riot's own documentation says, and the part I can't promise you."
    ...
    >
      ...
      <p>
        What gets accounts banned is a fundamentally different category of tool:{" "}
        ...
        code into the running game — which is precisely what anti-cheat is built
        to detect.
      </p>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            <td>
              <strong>Game file replacement</strong> — swapping model or texture
              files on disk
            </td>
            <td>Yes</td>
            <td>Yes</td>
      ...
      <p>
        ...
        that was never bought. The third changes nothing that a player
        couldn&apos;t change by clicking in the client — it just does it faster,
        and with a dice roll.
      </p>
      ...
      <p>
        ...
        client API, it states, &ldquo;are still expected to work&rdquo;. And:
        &ldquo;External tools reading memory will no longer work.&rdquo; That is
        the line — not &ldquo;third-party tools&rdquo; versus &ldquo;no
        tools&rdquo;, but tools that use the official local interface versus
      ...
      <p>
        ...
        under review. To be precise about what that does and doesn&apos;t mean:
        registering a product is not an endorsement, and Riot is explicit that it
        &ldquo;does not constitute endorsement, certification or approval&rdquo;.
        It means Riot knows the product exists and what it does.
      </p>
      ...
      <p>
        Every page you&apos;ll find on this subject tells you it&apos;s
        100% safe. Most of them are trying to sell you an account. Here is the
        honest version.
      </p>
      <ul>
        <li>
          <strong>Riot has no allow-list.</strong> They&apos;ve said so plainly:
          no third-party tool is whitelisted, mine included. There is no
          certificate I can show you.
        </li>
        <li>
          ...
          it will keep working. A client update could break Skin Picker without
          warning — that&apos;s a functionality risk, not a ban risk, but
          it&apos;s real.
        </li>
        <li>
      ...
      <p>
        The installer isn&apos;t signed with a paid certificate yet, so Windows
        SmartScreen warns about it — as it does for any unsigned program,
        regardless of what it contains. That&apos;s a statement about a
        certificate, not about the software. Every release is built automatically
        from the public repository by GitHub Actions, so what you download
        corresponds to source code you can read. Code signing is being worked on.
      </p>
